document.addEventListener('DOMContentLoaded', () => {
  ...
  const openModal = () => {
    ...
    if(catalogVideo && typeof catalogVideo.play === 'function') catalogVideo.play();
  };
  const closeModal = () => {
    videoModal.style.display = 'none';
    if(catalogVideo && typeof catalogVideo.pause === 'function') {
        catalogVideo.pause();
...
### خلاصه تغییرات کلیدی در CSS

*   **چیدمان‌های چند ستونی:** تمام بخش‌هایی که در دسکتاپ کنار هم بودند (مانند بخش مدیران، دلایل انتخاب ما، دپارتمان‌ها و لیست محصولات) در موبایل به صورت تک ستونی و کاملاً مرتب زیر هم قرار می‌گیرند.
*   **اندازه فونت‌ها و فاصله‌ها:** اندازه تمام متون و تیترها برای خوانایی بهتر در موبایل بهینه شده و فاصله‌های اضافی حذف شده‌اند تا از فضای صفحه به بهترین شکل استفاده شود.
*   **منوی بالای سایت (Header):** منوی اصلی در موبایل پنهان شده و لوگو و دکمه‌ها با اندازه‌ای متناسب نمایش داده می‌شوند تا هدر شلوغ نباشد.
*   **بخش Hero:** اندازه و موقعیت عکس محصول و متون در صفحه اصلی برای نمایش کامل و زیبا در موبایل تنظیم شده است.
*   **فوتر:** آیتم‌های فوتر در موبایل به جای کنار هم، زیر هم قرار می‌گیرند.

با این تغییرات، سایت شما هم در دسکتاپ ظاهر قبلی و عالی خود را حفظ می‌کند و هم در موبایل یک تجربه کاربری روان، خوانا و حرفه‌ای ارائه می‌دهد.
